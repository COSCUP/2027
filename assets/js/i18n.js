...
const EN = Object.freeze({
  ...
  'cta.volunteer': 'Join the crew',
  'cta.volunteerHint': 'Recruiting now',
  'cta.volunteerDoc': 'Read the full recruitment guide',
  ...
  'volunteer.title': 'Volunteer recruitment is open',
  'volunteer.badge': 'Now open',
  'volunteer.lede': 'Behind every COSCUP is a crew of volunteers. We are starting recruitment early so that 2027 is well prepared — and it is a stage where your work is seen by thousands of open source enthusiasts.',
  'volunteer.fallback': 'Ten teams are recruiting. See the full recruitment document for each team’s status and details.',
  'volunteer.applyTitle': 'What your application should include',
  'volunteer.applyNote': 'If the team you have in mind has no form open yet, prepare the items below and email them to',
  'volunteer.apply1': 'What we should call you (name or nickname)',
  'volunteer.apply2': 'The team you are applying for',
  'volunteer.apply3': 'How many COSCUPs you have attended, and in what role (volunteer / attendee / speaker)',
  'volunteer.apply4': 'Any experience organising other events or communities — and what your role was',
  'volunteer.apply5': 'Tools and skills you are comfortable with (design, photography, community management, languages, programming …)',
  'volunteer.apply6': 'A short introduction, so we get to know you',
  'volunteer.apply7': 'Roughly how many hours per week you can commit',
  'volunteer.apply8': 'Your contact email',
